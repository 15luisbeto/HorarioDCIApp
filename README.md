...
En Android con Development Build no registres `horariodciapp://...` como redirect en Google Cloud. El OAuth client Android se valida con package + SHA-1 y la app usa internamente:
